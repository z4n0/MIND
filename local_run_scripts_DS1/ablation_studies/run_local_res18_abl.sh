...
export MLFLOW_EXPERIMENT_NAME="${MLFLOW_EXPERIMENT_NAME:-ABLATION_STUDIES}"
...
# ── 3) launch training ──────────────────────────────────────────────────────
python train_with_ablation.py --yaml configs/4c/resnet18.yaml
