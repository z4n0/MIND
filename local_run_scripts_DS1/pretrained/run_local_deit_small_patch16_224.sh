...
job_name="deit_small_patch16_224_pretrained_local"
...
export MLFLOW_EXPERIMENT_NAME="${MLFLOW_EXPERIMENT_NAME:-SL_Pretrained}"
...
# ── 3) launch training ──────────────────────────────────────────────────────
python train_pretrained.py --yaml configs/pretrained_timm/deit_small_patch16_224.yaml
