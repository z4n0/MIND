...
job_name="deit_small_patch16_224_4c_pretrained_local"
...
export MLFLOW_EXPERIMENT_NAME="${MLFLOW_EXPERIMENT_NAME:-SL_Pretrained_4C_TIMM}"
...
# ── 3) launch training ──────────────────────────────────────────────────────
python train_pretrained.py --yaml configs/pretrained_timm_4c/deit_small_patch16_224.yaml
